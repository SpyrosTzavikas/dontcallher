...
public class sms_blocker extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (intent.getAction().equals(sms_blocker.OUTGOING_CALL_ACTION)) {
            Log.v(LOGTAG, "OutgoingCallReceiver NEW_OUTGOING_CALL received");

            // get phone number from bundle
            String phoneNumber = intent.getExtras().getString(sms_blocker.INTENT_PHONE_NUMBER);
